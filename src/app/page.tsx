...
export default function HomePage() {
  return (
    <div className="flex min-h-screen flex-col gap-6">
      <main className="flex flex-grow flex-col gap-3 lg:flex-row lg:gap-6 lg:pl-20">
        <div className="contents [&>section]:flex [&>section]:flex-1 [&>section]:lg:flex-row [&>section]:lg:items-center ">
          ...
          <section className="justify-center pl-3 pt-4 lg:justify-start">
            <Showcase />
          </section>
        </div>
      </main>
      <footer className="flex shrink-0 items-center justify-center pb-11 pt-7 lg:pb-10 lg:pt-2">
        <TV />
      </footer>
    </div>
  )
...
function TV() {
  ...
  return (
    <div className="flex flex-col gap-2">
      <div>
        <div className="scale-90 inline-flex max-w-fit items-center gap-1 rounded bg-red-700 -ml-[5px] py-1 pl-[0.33rem] pr-[0.34rem] font-sans text-white">
          <style>
            {`
            @keyframes pulse {
              0%, 100% {
      ...
      <div>
        <div className="scale-110 outer-panel rounded-2xl p-[0.25rem] shadow-[inset_0px_0px_10px_rgba(0,0,0,0.8)]">
